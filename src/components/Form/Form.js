...
const Form = ({ currentId, setCurrentId }) => {
  ...
  return (
    <Paper style={styles.paper}>
      <form autoComplete="off" noValidate style={{ ...styles.root, ...styles.form }} onSubmit={handleSubmit}>
        ...
        <Button style={styles.buttonSubmit} variant="contained" color="primary" size="large" type="submit" fullWidth>Submit</Button>
